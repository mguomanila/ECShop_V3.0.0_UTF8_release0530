...
class CategoryBaseModel extends BaseModel {
	...
	function get_child_tree_name($tree_id = 0){

        $sql1 = 'SELECT cat_name FROM ' . $this->pre . "category WHERE cat_id = '$tree_id' AND is_show = 1 ";
        	$cat_name=$this->Row($sql1);
    ...
    function get_child_tree($tree_id = 0) {
        ...
        $sql = 'SELECT count(*),cat_name FROM ' . $this->pre . "category WHERE parent_id = '$tree_id' AND is_show = 1 ";
