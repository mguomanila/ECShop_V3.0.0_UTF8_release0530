...
//              $vo['pay_status'] = ($vo['is_paid'] == 0) ? L('un_confirm') : L('is_confirm');
    ...
    public function select_user_account($rec_id, $user_id) {
        $sql='SELECT * FROM ' . $this->pre ."user_account WHERE is_paid = 0 AND id = '$rec_id'  AND user_id = '$user_id'";
     ...
     * @return  int
     */
    public function get_user_surplus_points($user_id) {
        $this->table = 'account_log';
        $condition['user_id'] = $user_id;
