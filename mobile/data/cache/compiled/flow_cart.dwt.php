...
?>
      <li>
        <div class="ect-clear-over"> <a href="<?php echo url('goods/index',array('id'=>$this->_var['goods']['goods_id']));?>"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>"></a>
          <div class="gwc_right">
            <div>
              <h4 class="title"><a class="gwc_a" href="<?php echo url('goods/index',array('id'=>$this->_var['goods']['goods_id']));?>"><?php echo $this->_var['goods']['goods_name']; ?> 
            ...
            <div class="ect-color999"> 
              <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              <p><?php echo nl2br($this->_var['goods']['goods_attr']); ?></p>
              <?php endif; ?>
              <p style="float: right;"><strong class="ect-colory"><?php echo $this->_var['goods']['goods_price']; ?></strong></p>
            </div>
...
?>
  ...
  <div class="flow-no-pro"> <img src="__TPL__/images/gwc.png">
    ...
    <a type="button" href="<?php echo url('category/top_all');?>" class="btn btn-info ect-btn-info ect-bg gwc-color"><?php echo $this->_var['lang']['go_shopping']; ?></a> </div>
  <?php endif; ?> 
</div>
