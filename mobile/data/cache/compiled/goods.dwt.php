...
?> 
  ...
  <div class="goods-info ect-padding-tb"> 
    ...
    <section class="ect-margin-tb ect-margin-lr goods-title ">
      <h4 class="title pull-left"><?php echo $this->_var['goods']['goods_style_name']; ?>&nbsp;&nbsp;<?php if ($this->_var['goods']['is_vip'] == 1): ?><span style="color: red;font-weight: 700;">(VIP专享)</span><?php endif; ?></h4>
      <span class="pull-right text-center ect-margin-na  <?php if ($this->_var['sc'] == 1): ?>ect-colory<?php endif; ?> ect-padding-lr" onClick="collect(<?php echo $this->_var['goods']['goods_id']; ?>)" id='ECS_COLLECT'> <i class="fa <?php if ($this->_var['sc'] == 1): ?>fa-heart<?php else: ?>fa-heart-o<?php endif; ?>"></i><br>
    ...
    <section class="ect-margin-tb ect-margin-lr">
      ...
      <?php endif; ?>
      <p>
        <?php echo $this->_var['lang']['amount']; ?>：<b class="ect-colory" id="ECS_GOODS_AMOUNT"></b>
      </p>
      
      
      <p>
        <?php echo $this->_var['lang']['sort_sales']; ?>：<?php echo $this->_var['sales_count']; ?> <?php echo $this->_var['lang']['piece']; ?>
      </p>
      ...
      <p><?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?><strong id="leftTime" class="price"><?php echo $this->_var['lang']['please_waiting']; ?></strong><?php endif; ?></p>
    	<!--<p>购买此商品可使用：<?php echo $this->_var['goods']['integral']; ?>金积分</p>-->
     	...
     	<a class="zxkf" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3275291540&site=qq&menu=yes" title="即刻发送您的需求"><img src="themes/default/images/qq_2.png" alt="" width="16vw" style="position: absolute;left: 0vw; top: 3vw;"/>在线咨询</a>
...
?>
        ...
        <div class="goods-num"> <span class="pull-left" style="line-height: 25px;"><?php echo $this->_var['lang']['number']; ?>：</span> 
      ...
      <a id="info_1" class="ect-padding-lr ect-padding-tb" onclick="query(<?php echo $this->_var['goods']['goods_id']; ?>,0)" style="width: 50%;display: inline-block;box-sizing: border-box;border-right: 1px solid #ccc;float: left;" <?php echo url('goods/info',array('id'=>$this->_var['goods']['goods_id']));?>><span class="Text"><?php echo $this->_var['lang']['goods_brief']; ?></span> <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a> 
      <a id="info_2" class="ect-padding-lr ect-padding-tb" onclick="query(<?php echo $this->_var['goods']['goods_id']; ?>,1)" style="width: 50%;display: inline-block;box-sizing: border-box;float: left;"<?php echo url('goods/comment_list',array('id'=>$this->_var['goods']['goods_id']));?>><span class="Text"><?php echo $this->_var['lang']['goods_comment']; ?></span> <span class="pull-right"><i class="fa fa-chevron-right"></i></span></a> 
      ...
      <script type="text/javascript">
      	function query(goods_id,type){
      		if(type == 1){
								$("#one").html('')
      				$("#comments").css('display','block');
      				$("#info_2").css({"background":"rgba(232,126,4,1)","color":"#fff"})
      				$("#info_1").css({"background":"#fff","color":"#333"})
      		}else{
	      		$.ajax({
	      			type:"get",
							url:"<?php echo url('goods/query');?>",
							data:"goods_id="+goods_id+"&type="+type,
							dataType:"json",
							success:function(result,status){
								console.log(result[0]['goods_desc'])
								
								$("#one").html( result[0]['goods_desc'])
      					$("#comments").css('display','none')
      					$("#info_1").css({"background":"rgba(232,126,4,1)","color":"#fff"})
      					$("#info_2").css({"background":"#fff","color":"#333"})
...
?>
  ...
  <div class="goods-related ect-padding-lr ect-padding-tb">
    ...
    <div id="picScroll" class="picScroll">
      ...
      <div class="bd">
        <ul>
          <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_74463600_1490768555');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_74463600_1490768555']):
        $this->_foreach['goods']['iteration']++;
?>
          <li><a href="<?php echo $this->_var['goods_0_74463600_1490768555']['url']; ?>"><img _src="<?php echo $this->_var['goods_0_74463600_1490768555']['goods_thumb']; ?>" src="<?php echo $this->_var['goods_0_74463600_1490768555']['goods_thumb']; ?>" /></a>
            <p class="ect-color"> 
              <?php if ($this->_var['goods_0_74463600_1490768555']['promote_price']): ?> 
              <?php echo $this->_var['goods_0_74463600_1490768555']['formated_promote_price']; ?>
              <?php else: ?> 
              <?php echo $this->_var['goods_0_74463600_1490768555']['shop_price']; ?>
              <?php endif; ?> 
            </p>
            <p class="text-left"><?php echo $this->_var['goods_0_74463600_1490768555']['short_name']; ?></p>
          </li>
  ...
  <footer class="logo"><a href="" title="ECTouch官网" target="_blank"><img src="__TPL__/images/copyright.png" width="176" height="60"></a></footer>
</div>
