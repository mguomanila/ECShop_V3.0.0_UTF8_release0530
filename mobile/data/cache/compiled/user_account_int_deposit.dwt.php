     ...
     <!--<li>
      ...
      <li id="content_text" style="display: ;">
       	<div class="input-text"><b class="pull-left">选择方案：</b><span>
       		...
       		<input type="radio" placeholder=""    name="precept" id="precept4" class="precept" value="4"/>方案四
       	...
       	<li style="text-align: center;background: #e1e1e1;padding:1em 4.6em;line-height: 26px;text-align: left;" id="ms">
				...
				2、按剩余总额的万分之六左右每天积分奖励，后续消费叠加。</br>
...
//		alert($(".precept").val())
		...
		}else if($("#precept3").is(":checked")){
			var a= $("#vr").val()*0.21;
		}else{
			var a= $("#vr").val()*0.3*0.07;
...
//				"7、原定普通会员的推荐奖励全部取消。"+"<br />"+
			...
			$("#ms").html(
				"1、前一天总营业额的12%作为次日消费奖励总额。"+"</br>"+
				"2、按剩余总额的万分之十左右每天积分奖励，后续消费叠加。"+"<br />"+
				"3、最终解释权归成都沃尔迅科技有限公司所有。"
			)
		}else{
			if($(".amount").val()>=1500){
