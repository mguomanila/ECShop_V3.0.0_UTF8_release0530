  ...
  <div class="ect-bg-colorf flow-consignee">
    <ul class="o-info">
      <li>
       ...
       <li style="padding: 1em 0.6em 1.7em;" id="duihuan">
     ...
     <li style="padding: 1em 0.6em 1.7em;" id="duihuan1">
...
<script type="text/javascript">
	$("#integral_one").on("click",function(){
		...
		if($("#duihuan1").css("display") == "none"){
			...
			$("#integral_two").toggleClass("integral_1_fa");
		}
		$("#duihuan1_ip").val("");
		$(".duihuan1_ye").html("");
	...
	$("#integral_two").on("click",function(){
		...
		if($("#duihuan").css("display") == "none"){
			...
			$("#duihuan").slideToggle("show");
			$("#integral_one").toggleClass("integral_1_fa");
		}
		$("#duihuan_ip").val("");
		$(".duihuan_ye").html("");
