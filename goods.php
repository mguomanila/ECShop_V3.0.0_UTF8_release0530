...
{
    $Loaction = 'http://www.oryigo.com/mobile/index.php?m=default&c=goods&a=index&id='.$_GET['id'];
...
$attr_id1    = isset($_REQUEST['attr']) ? explode(',', $_REQUEST['attr']) : array();
$number1     = (isset($_REQUEST['number'])) ? intval($_REQUEST['number']) : 1;
$shop_price1  = get_final_price($goods_id, $number1, true, $attr_id1);
$shop_price1=$shop_price1*100;

$smarty->assign('goods_jifen', $shop_price1);
/* 记录浏览历史 */
