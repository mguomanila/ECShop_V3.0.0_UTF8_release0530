...
if($_GET['act']=='send'){
	...
	if(!preg_match($preg,$mobile)) {
		...
		exit(json_encode(array('msg'=>$_POST['mobile'].'手机号码格式不正确')));
	 }	
	...
	$post_data = "account=cf_z297875361&password=".md5('m374520CIXINUpy')."&mobile=".$mobile."&content=".rawurlencode("您的验证码是：".$mobile_code."。请不要把验证码泄露给其他人。");
