...
$_LANG['supplierstype']	 = '是否供货商';
$_LANG['suppliers_type'][1] = '否';
$_LANG['suppliers_type'][2] = '是';

$_LANG['view_order'] = '查看订单';
$_LANG['view_deposit'] = '查看账目明细';
$_LANG['username'] = '会员名称';
$_LANG['email'] = '邮件地址';
$_LANG['is_validated'] = '是否经销商';
$_LANG['reg_date'] = '注册日期';
...
$_LANG['sex'][1] = '男';
$_LANG['sex'][2] = '女';
$_LANG['pay_points'] = '金积分一';
$_LANG['pay_points_2'] = '金积分二';
...
$_LANG['consumption_sum'] = '金额';
$_LANG['adress_sum'] = '地区';
$_LANG['gold_ingot'] = '金元宝一';
$_LANG['gold_ingot_2'] = '金元宝二';
